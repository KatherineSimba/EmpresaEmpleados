...
namespace Empresa.Migrations
{
    ...
    [Migration("20180304190709_EmpleadoCategorias-Agrego-Activo")]
    partial class EmpleadoCategoriasAgregoActivo
    {
            ...
            modelBuilder.Entity("EFCoreEjemplos.EmpleadoCategoria", b =>
                {
                    ...
                    b.HasOne("EFCoreEjemplos.Empleadoe", "Empleado")
                        .WithMany("EmpleadosCategorias")
                        .HasForeignKey("EmpleadoeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
